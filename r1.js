...
window.STORY_R1 = {
  ...
  nodes: [
    ...
    { id: "r1_from_intro5", name: "みや", text: "出口…ではなさそうですね。", portrait:{ who:"miya", face:"fear", size:"500px" },next: "r1_from_intro6" },
    { id: "r1_from_intro6", name: "みや", text: "でも、調べられる箇所が一気に増えた気がします！",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_from_intro7" },
    { id: "r1_from_intro7", name: "あなた", text: "確かに…脱出の手がかりが見つかる可能性が増えたかもしれない。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_from_intro8" },
    ...
    { id: "r1_koto6", name: "みや", text: "凄い…お箏に詳しいんですね！",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_koto7" },
    { id: "r1_koto7", name: "あなた", text: "まぁ、三曲研究部にいるしね…",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_koto8" },
    { id: "r1_koto8", name: "あなた", text: "なんなら、みやも中高時代箏曲部じゃなかったっけ？",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_koto9" },
    { id: "r1_koto9", name: "みや", text: "中高…箏…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_koto10" },
    { id: "r1_koto10", name: "あなた", text: "……もしかして、覚えてない？",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_koto11" },
    { id: "r1_koto11", name: "みや", text: "…すみません。", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r1_koto12" },
    { id: "r1_koto12", name: "あなた", text: "大丈夫だよ、ゆっくり思い出していこう。",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_koto13" },
    ...
    { id: "r1_honndana3", name: "みや", text: "この本、明らかにアラビア圏の言語っぽい本ですね…", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_honndana4" },
    { id: "r1_honndana4", name: "みや", text: "アラビア語とか読めたりしますか？",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_honndana5" },
    { id: "r1_honndana5", name: "あなた", text: "いや…さすがに分からないな…",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_honndana6" },
    { id: "r1_honndana6", name: "みや", text: "ですよね…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_honndana7" },
    ...
    { id: "r1_honndana9", name: "みや", text: "そ、操作…？楽器なのに妙な表現ですね…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_honndana10" },
    ...
    { id: "r1_honndana22", name: "みや", text: "ひとまず、凄い箏であることは分かりました…!!",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_honndana23" },
    { id: "r1_honndana23", name: "あなた", text: "この本の内容が本当か嘘かは置いといて、なんでそんな箏がこんなところに…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_honndana24" },
    { id: "r1_honndana24", name: "みや", text: "何か脱出の手がかりになるんでしょうか？",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_honndana25" },
    { id: "r1_honndana25", name: "みや", text: "この箏を演奏したら、鍵がもらえたりして。", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r1_honndana26" },
    { id: "r1_honndana26", name: "あなた", text: "うーん…だとしても、3つの指輪が必要らしい。",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_honndana27" },
    ...
    //箏を観察する
    { id: "r1_look_koto", name: "みや", text: "やっぱり、箏っておいてあるだけで迫力凄いですね…", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_look_koto2" },
    { id: "r1_look_koto2", name: "あなた", text: "確かに…普通に自分の身長より大きいもんな…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_look_koto3" },
    { id: "r1_look_koto3", name: "あなた", text: "（立てかけてある箏が倒れてきたら流石に無傷はないだろうし…）", next: "r1_look_koto4" },
    { id: "r1_look_koto4", name: "みや", text: "…あれ？箏に何か彫られてません…？", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_look_koto5" },
    ...
    { id: "r1_look_koto8", name: "みや", text: "で、でも私は、箏のことを覚えていないですし…", portrait:{ who:"miya", face:"fear", size:"500px" },next: "r1_look_koto9" },
    { id: "r1_look_koto9", name: "みや", text: "弾くにしたって何を演奏すればいいのか…", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r1_look_koto10" },
    ...
    { id: "r1_touch_koto7", name: "みや", text: "凄い…よく分かりますね!",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_touch_koto8" },
    { id: "r1_touch_koto8", name: "あなた", text: "み、みや!?", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_touch_koto9" },
    { id: "r1_touch_koto9", name: "あなた", text: "いつから背後に!?", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_touch_koto10" },
    { id: "r1_touch_koto10", name: "みや", text: "「ちょっと箏移動させるか…、って重!?」", portrait:{ who:"miya", face:"fear", size:"500px" },next: "r1_touch_koto11" },
    { id: "r1_touch_koto11", name: "みや", text: "のあたりからです",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_touch_koto12" },
    { id: "r1_touch_koto12", name: "あなた", text: "(ほぼ最初からじゃん…）",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_touch_koto13" },
    { id: "r1_touch_koto13", name: "あなた", text: "…それで、みやはこの箏に用があったの？",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_touch_koto14" },
    { id: "r1_touch_koto14", name: "みや", text: "あ、いえ、箏ではなくて…", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_touch_koto15" },
    { id: "r1_touch_koto15", name: "みや", text: "あなたにちょっと見せたいものがありまして…", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_touch_koto16" },
    { id: "r1_touch_koto16", name: "あなた", text: "自分に…？", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_touch_koto17" },
    { id: "r1_touch_koto17", name: "みや", text: "はい!お時間のある時でいいので、掛け軸の所まで来ていただけますか…？", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_touch_koto18" },
    ...
    { id: "r1_try_koto17", name: "みや", text: "やめて下さい…!!", portrait:{ who:"miya", face:"fear", size:"500px" },next: "r1_try_koto18" },
    { id: "r1_try_koto18", name: " ", text: "......", portrait:{ who:"miya", face:"fear", size:"500px" },next: "r1_try_koto19" },
    { id: "r1_try_koto19", name: " ", text: ".....みや?",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_try_koto20" },
    { id: "r1_try_koto20", name: "みや", text: "大丈夫ですか…?", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r1_try_koto21" },
    { id: "r1_try_koto21", name: " ", text: "大丈．．．あれ、自分は一体何を．．．?",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_try_koto22" },
    ...
    { id: "r1_try_koto25", name: "みや", text: "…演奏を止めてしまってすみません。",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_try_koto26" },
    { id: "r1_try_koto26", name: "みや", text: "ただ…ちょっと、これ以上聞いていると、頭がおかしくなりそうな音だったので…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_try_koto27" },
    { id: "r1_try_koto27", name: "みや", text: "勿論、演奏そのものが嫌だった訳では無いんですけど…", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r1_try_koto28" },
    { id: "r1_try_koto28", name: "みや", text: "頭に直接響き渡る…と言いますか、ちょっと…刺激が強くて…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_try_koto29" },
    ...
    { id: "r1_try_koto31", name: "みや", text: "どうかしました…?", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_try_koto32" },
    { id: "r1_try_koto32", name: "あなた", text: "ううん、なんでもないよ。それと、演奏を止めてくれてありがとう。", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_try_koto33" },
    { id: "r1_try_koto33", name: "みや", text: "ふふ…演奏を止めてお礼を言われると思っていませんでした。",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_try_koto34" },
    { id: "r1_try_koto34", name: "みや", text: "どういたしまして、ですかね?",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_try_koto35" },
    ...
    //箏を演奏する(不完全＿二回目)
    { id: "r1_try_koto_again", name: "みや", text: "え、もう一回弾くんですか…？",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_try_koto_again2" },
    { id: "r1_try_koto_again2", name: "あなた", text: "(みやが凄く嫌そうな顔をしている…)",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_try_koto_again3" },
    ...
    { id: "r1_play_koto2", name: "みや", text: "本当ですか!!ありがとうございます!!", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r1_play_koto3" },
    { id: "r1_play_koto3", name: "あなた", text: "これで…いいんだよな?",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_play_koto4" },
    { id: "r1_play_koto4", name: "みや", text: "先ほど見つけた本によると…恐らく大丈夫なはずです。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_play_koto5" },
    { id: "r1_play_koto5", name: "みや", text: "それにしても、指輪を3つ装着するだけで、本当に箏が弾けるんですかね…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_play_koto6" },
    { id: "r1_play_koto6", name: "あなた", text: "資料には確かに書いてあったけど、実際出来るのかもよく分かってないしな。",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_play_koto7" },
    { id: "r1_play_koto7", name: "みや", text: "うーん、どちらにしてもそれを付けて演奏しないと分からないですよね。",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_play_koto8" },
    { id: "r1_play_koto8", name: "みや", text: "一回弾いてみるのがいいんじゃないでしょうか?", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_play_koto9" },
    { id: "r1_play_koto9", name: "あなた", text: "それもそうだな。", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_play_koto10" },
    { id: "r1_play_koto10", name: "みや", text: "それで…どちらが演奏します?",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_play_koto11" },
    { id: "r1_play_koto11", name: "あなた", text: "(…確かに。指輪は3つだけ。二人分の指輪はないな。)", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_play_koto12" },
    { id: "r1_play_koto12", name: "あなた", text: "箏の側面にも、どっちが弾けとか書かれてなかったし…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_play_koto13" },
    { id: "r1_play_koto13", name: "あなた", text: "みやは演奏したいとかある…?",portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_play_koto14" },
    { id: "r1_play_koto14", name: "みや", text: "うーん、特に希望はないですね。",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_play_koto15" },
    { id: "r1_play_koto15", name: "みや", text: "むしろ逆に何か希望はありますか…？",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_play_koto16" },
    { id: "r1_play_koto16", name: "みや", text: "指輪を見つけたのはあなたですし、決めてもらった方が私もありがたいです。", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_play_koto17" },
    { id: "r1_play_koto17", name: "みや", text: "どっちが弾け…のように書かれた資料は見当たらなかったですし、本当にどちらでも大丈夫なんだと思います。", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r1_play_koto18" },
    { id: "r1_play_koto18", name: "あなた", text: "指輪を付けると弾き方が分かるらしいので、もし本当であれば、あなたが箏を弾いたことがあってもなくても、きっと演奏が出来ると思いますよ。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_play_koto19" },
    ...
    { id: "r1_あなた_koto2", name: "みや", text: "はい!!", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r1_あなた_koto3" },
    { id: "r1_あなた_koto3", name: "あなた", text: "…あれ、なんか嬉しそう?", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r1_あなた_koto4" },
    { id: "r1_あなた_koto4", name: "みや", text: "あ…実は、ちょっと安心してて…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_あなた_koto5" },
    { id: "r1_あなた_koto5", name: "あなた", text: "安心?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_あなた_koto6" },
    { id: "r1_あなた_koto6", name: "みや", text: "記憶が戻っていないので…上手く弾ける自信がなかったのと、",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_あなた_koto7" },
    { id: "r1_あなた_koto7", name: "みや", text: "もし私に箏に対する記憶があるなら…あなたの演奏を聴いて、何か思い出すかもしれないなと思って。", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_あなた_koto8" },
    { id: "r1_あなた_koto8", name: "あなた", text: "そっか…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_あなた_koto9" },
    { id: "r1_あなた_koto9", name: "あなた", text: "みやが何か感じられるようになるべく頑張るね!",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_あなた_koto10" },
    { id: "r1_あなた_koto10", name: "あなた", text: "って言っても、どう頑張るのか分からないけど…", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_あなた_koto11" },
    ...
    { id: "r1_あなた_koto33", name: "みや", text: "お疲れ様です…!!",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_あなた_koto34" },
    { id: "r1_あなた_koto34", name: "あなた", text: "お、終わったのか?", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_あなた_koto35" },
    { id: "r1_あなた_koto35", name: "みや", text: "凄かったですよ!!迫力もあって…圧倒されてました。",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_あなた_koto36" },
    { id: "r1_あなた_koto36", name: "あなた", text: "(そ、そんな風に聞こえてたんだ…指輪の力を借りたとはいえ、ちょっと嬉しいな)",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_あなた_koto37" },
    { id: "r1_あなた_koto37", name: "あなた", text: "それで…みやは、何か思い出せた?", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r1_あなた_koto38" },
    { id: "r1_あなた_koto38", name: "みや", text: "…うーん、まだ、思い出せていないです。こんな素敵な演奏をしてくださったのに、すみません。", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r1_あなた_koto39" },
    { id: "r1_あなた_koto39", name: "あなた", text: "…ううん、大丈夫だよ。",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_あなた_koto40" },
    { id: "r1_あなた_koto40", name: "みや", text: "ありがとうございます。…ただ、", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_あなた_koto41" },
    { id: "r1_あなた_koto41", name: "あなた", text: "…ただ？",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_あなた_koto42" },
    { id: "r1_あなた_koto42", name: "みや", text: "あなたの箏を聞いてると――", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_あなた_koto43" },
    { id: "r1_あなた_koto43", name: "みや", text: "…少し懐かしいような気がしたんです。",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_あなた_kagi" },

    // === みやに演奏してもらう ===
    { id: "r1_みや_koto", name: "あなた", text: "みやにお願いしてもいいかな?", next: "r1_みや_koto2" },
    { id: "r1_みや_koto2", name: "みや", text: "え…!!本当に言ってます!?",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_みや_koto3" },
    { id: "r1_みや_koto3", name: "みや", text: "まだ記憶戻ってませんし…和楽器のことあなたよりも分からないですし…", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r1_みや_koto4" },
    { id: "r1_みや_koto4", name: "あなた", text: "さっきの本には、誰でも演奏できるって書いてあるから、箏のことを分かってなくても弾けると思うよ。", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r1_みや_koto5" },
    { id: "r1_みや_koto5", name: "あなた", text: "それに、自分の知ってるみやだったら、箏を弾いたことがあるはずなんだ。", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r1_みや_koto6" },
    { id: "r1_みや_koto6", name: "あなた", text: "箏を弾いたら、もしかしたら何か感じられるかもしれないし…", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r1_みや_koto7" },
    { id: "r1_みや_koto7", name: "みや", text: "……",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_みや_koto8" },
    { id: "r1_みや_koto8", name: "みや", text: "確かに…一理ありますね。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_みや_koto9" },
    { id: "r1_みや_koto9", name: "みや", text: "でも…本当にいいんですか?",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_みや_koto10" },
    { id: "r1_みや_koto10", name: "みや", text: "記憶が無い人に任せても。",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_みや_koto11" },
    { id: "r1_みや_koto11", name: "あなた", text: "…うん。むしろ多分みやの方が上手に弾けるんじゃないかな?",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_みや_koto12" },
    { id: "r1_みや_koto12", name: "みや", text: "それだけは絶対ありえないです!",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_みや_koto13" },
    { id: "r1_みや_koto13", name: "みや", text: "でも…ありがとうございます。", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_みや_koto14" },
    { id: "r1_みや_koto14", name: "みや", text: "私、やってみますね!",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_みや_koto15" },
    { id: "r1_みや_koto15", name: "あなた", text: "うん!頑張って!",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_みや_koto16" },
    ...
    { id: "r1_みや_koto24", name: "みや", text: "…なんででしょう。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_みや_koto25" },
    { id: "r1_みや_koto25", name: "みや", text: "…どこか、懐かしく思います。", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_みや_koto26" },
    ...
    { id: "r1_みや_koto31", name: " ", text: "……", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r1_みや_koto32" },
    { id: "r1_みや_koto32", name: " ", text: "えっと……",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_みや_koto33" },
    { id: "r1_みや_koto33", name: "みや", text: "…多分、終わりました。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_みや_koto34" },
    { id: "r1_みや_koto34", name: "あなた", text: "お疲れ様!凄かったよ!", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r1_みや_koto35" },
    { id: "r1_みや_koto35", name: "みや", text: "ありがとうございます…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_みや_koto36" },
    { id: "r1_みや_koto36", name: "みや", text: "箏を演奏するのに夢中で、自分の音は殆ど耳に入らなかったんですけど…", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r1_みや_koto37" },
    { id: "r1_みや_koto37", name: "みや", text: "いい演奏が出来ていたのなら…よかったです。",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_みや_koto38" },
    { id: "r1_みや_koto38", name: "あなた", text: "ちなみに、何か思い出せたりは…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_みや_koto39" },
    { id: "r1_みや_koto39", name: "みや", text: "…それが、まだ何も思い出せていなくて…",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_みや_koto40" },
    { id: "r1_みや_koto40", name: "あなた", text: "そっか…",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_みや_koto41" },
    { id: "r1_みや_koto41", name: "みや", text: "でも、とても楽しかったです!",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_みや_koto42" },
    { id: "r1_みや_koto42", name: "みや", text: "弾かせてくれて、ありがとうございました。",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_みや_koto43" },
    ...
    { id: "r1_あなた_kagi3", name: "みや", text: "もしかしたら、箏を弾いたことで、何か変わったのかもしれません…!!",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_あなた_kagi4" },
    { id: "r1_あなた_kagi4", name: "あなた", text: "そうだね!", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r1_あなた_kagi5" },
    ...
    { id: "r1_kibako5", name: "みや", text: "こんなところに木箱があったんですね!",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_kibako6" },
    { id: "r1_kibako6", name: "あなた", text: "そうそう、自分が見た時は鍵がかかってて開かなかったんだよね",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_kibako7" },
    { id: "r1_kibako7", name: "みや", text: "中には何が入ってますか?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_kibako8" },
    ...
    { id: "r1_kibako_hatsu2", name: "みや", text: "カーテンの後ろに何かありましたか？", ortrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_kibako_hatsu3" },
    { id: "r1_kibako_hatsu3", name: "あなた", text: "鍵がついてる小さな木箱があったんだけど…今は鍵が掛かってないんだよね。",portrait:{ who:"miya", face:"normal", size:"500px" },  next: "r1_kibako_hatsu4" },
    { id: "r1_kibako_hatsu4", name: "あなた", text: "もしかしたら、さっきの演奏が終わった後の「カチャ」って音はこの木箱かも。", portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_kibako_hatsu5" },
    { id: "r1_kibako_hatsu5", name: "あなた", text: "なるほど…！！見つかってよかったですね！",portrait:{ who:"miya", face:"kind", size:"500px" },  next: "r1_kibako7" },
    ...
    { id: "r1_kibako17", name: "あなた", text: "うーん…飲むのか？それとも何かにかけるのか？",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_kibako18" },
    { id: "r1_kibako18", name: "みや", text: "見た目が毒々しいので、飲むのはちょっと…",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_kibako19" },
    ...
    { id: "r1_kirara", name: "みや", text: "来て下さったんですね！ありがとうございます！",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_kirara2" },
    { id: "r1_kirara2", name: "あなた", text: "…それで?見せたいものって",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r1_kirara3" },
    { id: "r1_kirara3", name: "みや", text: "はい、これなんですけど…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_kirara4" },
    ...
    { id: "r1_kirara13", name: "みや", text: "いえ…全く。記憶が戻ってないので何ともいえませんが…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_kirara14" },
    { id: "r1_kirara14", name: "あなた", text: "そっか…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_kirara15" },
    { id: "r1_kirara15", name: "みや", text: "これも何かの手がかり…なんでしょうか?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_kirara16" },
    ...
    { id: "r1_kakejiku_kirara5", name: "みや", text: "どうしました?",portrait:{ who:"miya", face:"normal", size:"500px" },  next: "r1_kakejiku_kirara6" },
    { id: "r1_kakejiku_kirara6", name: "あなた", text: "服…", portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r1_kakejiku_kirara7" },
    { id: "r1_kakejiku_kirara7", name: "みや", text: "服…?ああ！可愛いですよね！", portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_kakejiku_kirara8" },
    { id: "r1_kakejiku_kirara8", name: "あなた", text: "いや、そうじゃなくて…", portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r1_kakejiku_kirara9" },
    { id: "r1_kakejiku_kirara9", name: "あなた", text: "さっきの白い部屋で、自分が金縛りにあった時に、この服を着たみやを見たんだよ。",portrait:{ who:"miya", face:"smile", size:"500px" },  next: "r1_kakejiku_kirara10" },
    { id: "r1_kakejiku_kirara10", name: "みや", text: "……",portrait:{ who:"miya", face:"fear", size:"500px" },  next: "r1_kakejiku_kirara11" },
    { id: "r1_kakejiku_kirara11", name: "あなた", text: "そんな怪訝な目で見ないで…本当だから…",portrait:{ who:"miya", face:"fear", size:"500px" },  next: "r1_kakejiku_kirara12" },
    ...
    { id: "r1_kakejiku_kirara15", name: "みや", text: "……", portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_kakejiku_kirara16" },
    { id: "r1_kakejiku_kirara16", name: "あなた", text: "み、みや?", next: "r1_kakejiku_kirara17" },
    { id: "r1_kakejiku_kirara17", name: "みや", text: "なんでそんな重要そうなことを共有しないんですか!!!",portrait:{ who:"miya", face:"fear", size:"500px" },  next: "r1_kakejiku_kirara18" },
    { id: "r1_kakejiku_kirara18", name: "あなた", text: "ご、ごめん…伝えようとは思ってたんだよ。", portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_kakejiku_kirara19" },
    { id: "r1_kakejiku_kirara19", name: "あなた", text: "でも、あまりに非現実的だったし…気のせいかもしれないし…", portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_kakejiku_kirara20" },
    { id: "r1_kakejiku_kirara20", name: "みや", text: "だったら、この空間に居ること自体、非現実的じゃないですか!!",portrait:{ who:"miya", face:"confuse", size:"500px" },  next: "r1_kakejiku_kirara21" },
    { id: "r1_kakejiku_kirara21", name: "みや", text: "それに、もし刃物だったとしたら、怪我をしていたかもしれないんですよ!!",portrait:{ who:"miya", face:"fear", size:"500px" },  next: "r1_kakejiku_kirara22" },
    { id: "r1_kakejiku_kirara22", name: "みや", text: "ただでさえ、こんな状況なんですから…心配を掛けさせないでくださいよ…",portrait:{ who:"miya", face:"confuse", size:"500px" },  next: "r1_kakejiku_kirara23" },
    ...
    { id: "r1_kakejiku_kirara25", name: "みや", text: "…今、別のこと考えてません?", portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r1_kakejiku_kirara26" },
    { id: "r1_kakejiku_kirara26", name: "あなた", text: "いやいや！考えてない考えてない!!",portrait:{ who:"miya", face:"confuse", size:"500px" },  next: "r1_kakejiku_kirara27" },
    { id: "r1_kakejiku_kirara27", name: "みや", text: "もし、次同じようなことがあったら、必ず教えて下さいね!!",portrait:{ who:"miya", face:"fear", size:"500px" },  next: "r1_kakejiku_kirara28" },
    { id: "r1_kakejiku_kirara28", name: "あなた", text: "わ、分かりました…", portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_kakejiku_kirara29" },
    { id: "r1_kakejiku_kirara29", name: "あなた", text: "(……圧が凄い)", portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r1_kakejiku_kirara30" },
