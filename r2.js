...
window.STORY_R2 = {
  ...
  chars:{
    みや:{ defaultSize:"500px", defaultX:"50%", defaultY:"43%", faces:{ normal:"みや.normal.png", smile:"みや.smile.png", kind:"みや.kind.png", fear:"みや.fear.png", confuse:"みや.confuse.png",ormal:"./kirara.normal.png",mile:"./kirara_smile.png",ind:"./kirara_kind.png"}},
    みや_bad:{ defaultSize:"500px",defaultX:"50%", defaultY:"43%",  faces:{ normal:"みや.狂.png", angry:"みや.angry.狂.png", tear:"みや.tear.狂.png", smile:"みや.smile.狂.png",} }
 },
  info: {
    hekiga: { 
  ...
  nodes: [
    ...
    { id: "r2_intro4", name: "みや", text: "そうですね…それに、さっきよりも肌寒さ感じます。",portrait:{ who:"miya", face:"confuse" }, next: "r2_intro5" },
    { id: "r2_intro5", name: "あなた", text: "障子、畳…さっきは箏があったけど、この部屋はより和要素が強い気がする。",portrait:{ who:"miya", face:"confuse" }, next: "r2_intro6" },
    { id: "r2_intro6", name: "みや", text: "でも、和に関連していないものもありますよ…ぬいぐるみとか。", portrait:{ who:"miya", face:"normal" },next: "r2_intro7" },
    { id: "r2_intro7", name: "あなた", text: "(このぬいぐるみ達の仲間外れ感が凄いな…)", next: "r2_intro8" },
    { id: "r2_intro8", name: "あなた", text: "…随分と調べがいのありそうな部屋だね。", next: "r2_intro9" },
    { id: "r2_intro9", name: "みや", text: "そうですね、先ほどの部屋と同じように探索してみましょうか。", portrait:{ who:"miya", face:"kind" },set: { flags:["r2_started"] }, portrait:{ who:"miya", face:"confuse" }, next: "r2_hub" },

    // ===== 探索ハブ =====
    { id: "r2_hub", ui: { silent: true },set:{bgm:"tannsaku"},
      explore: {
        spots: [
          { id:"r2_case", x:"50%", y:"60%", size:"48px", icon:"./kirakira.png", next:"r2_peek_case", nextRepeat:"r2_try_code_hub", nextRepeatIfFlags:[
            {flags:["r2_case_open"],next:"r2_finish_code_hub"},
            {flags:["r2_candle_backup"],next:"r2_open_case"},
            {flags:[],next:"r2_try_code_hub"}
          ] },
          { id:"r2_torikago", x:"85%", y:"25%", size:"48px", icon:"./kirakira.png", next:"r2_look_torikago", nextRepeat:"r2_look_torikago_again" },
          { id:"r2_tennkei", x:"20%", y:"20%", size:"48px", icon:"./kirakira.png", next:"r2_look_tennkei", nextRepeat:"r2_hub" },
          { id:"r2_doll1", x:"40%", y:"55%", size:"48px", icon:"./kirakira.png", next:"r2_look_doll1", nextRepeat:"r2_look_doll1_again" },
          { id:"r2_doll2", x:"20%", y:"53%", size:"48px", icon:"./kirakira.png", next:"r2_look_doll2", nextRepeat:"r2_look_doll2_again" },
          { id:"r2_doll3", x:"80%", y:"53%", size:"48px", icon:"./kirakira.png", next:"r2_look_doll3", nextRepeat:"r2_look_doll3_again" },
          { id:"r2_tuner", x:"28%", y:"85%", size:"48px", icon:"./kirakira.png", next:"r2_look_tuner", nextRepeat:"r2_hub" },
          { id:"r2_manual", x:"60%", y:"65%", size:"48px", icon:"./kirakira.png", next:"r2_shami_manual", nextRepeat:"r2_shami_manual_again" },
          ...
          { id:"r2_look_daliy", x:"5%", y:"50%", size:"48px", icon:"./kirakira.png", next:"r2_nikki", nextRepeat:"r2_nikki_again" },
        ],
        talk: { sprite:"./みや.stand.png", x:"12%", y:"72%", size:"270px", next:"r2_talk_みや1" },
      }
    },

    // ===== ケース観察 =====
    { id: "r2_peek_case", name: " ", text: "畳の部屋に細長いケースが置かれている。", next: "r2_peek_case2" },
    { id: "r2_peek_case2", name: "みや", text: "これは…何でしょう?スーツケースにしては随分と細長いですね。", portrait:{ who:"miya", face:"normal" },next: "r2_peek_case3" },
    { id: "r2_peek_case3", name: "みや", text: "それに結構頑丈そうです。",portrait:{ who:"miya", face:"kind" }, next: "r2_peek_case4" },
    { id: "r2_peek_case4", name: "あなた", text: "…もしかして、三味ケース?", next: "r2_peek_case5" },
    { id: "r2_peek_case5", name: "みや", text: "三味ケース…?",portrait:{ who:"miya", face:"normal" }, next: "r2_peek_case6" },
    { id: "r2_peek_case6", name: "あなた", text: "三味線のケースだよ。中に三味線と備品が入ってるはず。", portrait:{ who:"miya", face:"normal" }, next: "r2_peek_case7" },
    { id: "r2_peek_case7", name: "みや", text: "そうなんですね!", portrait:{ who:"miya", face:"kind" }, next: "r2_peek_case8" },
    { id: "r2_peek_case8", name: "みや", text: "三味線のケースって結構大きいんですね。しかも頑丈そうですし…", portrait:{ who:"miya", face:"normal" }, next: "r2_peek_case9" },
    { id: "r2_peek_case9", name: "みや", text: "これに入れたら雨の中でも持ち運べそうですね!",portrait:{ who:"miya", face:"smile" }, next: "r2_peek_case10" },
    { id: "r2_peek_case10", name: "あなた", text: "…本当に覚えてないんだな。", portrait:{ who:"miya", face:"smile" },next: "r2_peek_case11" },
    { id: "r2_peek_case11", name: "みや", text: "…ん?今何か言いました?",portrait:{ who:"miya", face:"normal" }, next: "r2_peek_case12" },
    { id: "r2_peek_case12", name: "あなた", text: "あ、ううん!!何でもない!",portrait:{ who:"miya", face:"normal" }, next: "r2_peek_case13" },
    ...
    { id: "r2_peek_case15", name: "みや", text: "…あれ?ここ見てください!", portrait:{ who:"miya", face:"normal" },next: "r2_peek_case16" },
    { id: "r2_peek_case16", name: "あなた", text: "これは…南京錠?", next: "r2_peek_case17" },
    { id: "r2_peek_case17", name: "みや", text: "はい、3桁の番号が必要みたいです。",portrait:{ who:"miya", face:"normal" }, next: "r2_peek_case18" },
    { id: "r2_peek_case18", name: "あなた", text: "今回は3桁の番号を探し出せ…ってことか?",portrait:{ who:"miya", face:"normal" }, next: "r2_peek_case19" },
    { id: "r2_peek_case19", name: "みや", text: "番号…3桁の番号なんて、見てないですね",portrait:{ who:"miya", face:"confuse" }, next: "r2_peek_case20" },
    ...
    { id: "r2_look_tennkei2", name: "みや", text: "これは三味線…のように見えますが…",portrait:{ who:"miya", face:"confuse" }, next: "r2_look_tennkei3" },
    ...
    { id: "r2_look_tennkei5", name: "みや", text: "さっきの部屋が箏の部屋だとすると、ここは三味線の部屋…ですかね?",portrait:{ who:"miya", face:"normal" }, portrait:{ who:"miya", face:"normal" }, next: "r2_look_tennkei6" },
    { id: "r2_look_tennkei6", name: "あなた", text: "どっちも和楽器だね。",portrait:{ who:"miya", face:"normal" }, portrait:{ who:"miya", face:"normal" }, next: "r2_look_tennkei7" },
    { id: "r2_look_tennkei7", name: "みや", text: "なにかテーマのようなものがあるのでしょうか?", portrait:{ who:"miya", face:"kind" },portrait:{ who:"miya", face:"normal" }, next: "r2_look_tennkei8" },
    { id: "r2_look_tennkei8", name: "あなた", text: "その可能性が高いね…",portrait:{ who:"miya", face:"kind" }, portrait:{ who:"miya", face:"normal" }, next: "r2_look_tennkei9" },
    { id: "r2_look_tennkei9", name: "みや", text: "(だとすると、次の部屋も和楽器に関した部屋…なのか?)", portrait:{ who:"miya", face:"confuse" }, next: "r2_look_tennkei10" },
    { id: "r2_look_tennkei10", name: "あなた", text: "今回は三味線を演奏すると、何かが起こったりするのかな?", portrait:{ who:"miya", face:"normal" }, next: "r2_look_tennkei11" },
    { id: "r2_look_tennkei11", name: "みや", text: "うーん、どうでしょう…", portrait:{ who:"miya", face:"confuse" }, next: "r2_look_tennkei12" },
    { id: "r2_look_tennkei12", name: "みや", text: "今この部屋に三味線が見つかっていない以上、演奏するとは限らないと思います。", portrait:{ who:"miya", face:"kind" }, next: "r2_look_tennkei13" },
    { id: "r2_look_tennkei13", name: "みや", text: "…もう少し、この部屋を見て回りませんか?", portrait:{ who:"miya", face:"normal" }, next: "r2_look_tennkei14" },
    { id: "r2_look_tennkei14", name: "あなた", text: "そうだね。", portrait:{ who:"miya", face:"normal" }, next: "r2_look_tennkei15" },
    ...
    { id: "r2_look_doll2_7", name: " ", text: "情報:『くまのぬいぐるみ』を手に入れた。", se: "infomation", portrait:{ who:"miya", face:"confuse" }, set: { flags:["r2_kuma"],info:["r2_kuma_doll"] }, next: "r2_hub" },
    ...
    { id: "r2_tune_doll2_5", name: "あなた", text: "チューナーには『G』と表示されている。", portrait:{ who:"miya", face:"normal" }, next: "r2_tune_doll2_6" },
    ...
    { id: "r2_shami_manual4", name: " ", text: "『みんな!三味線を弾いてみたいって思ったことはないかい?うんうん、きっとあるはずだ!』", portrait:{ who:"miya", face:"kind" }, next: "r2_shami_manual5" },
    ...
    { id: "r2_nikki2", name: "あなた", text: "この本、二冊とも中身が白紙ですね…しかも表紙にも何も描かれてないです。", portrait:{ who:"miya", face:"normal" }, next: "r2_nikki3" },
    ...
    { id: "r2_nikki54", name: " ", text: "それだけ美味いものを発明したんだ。ちょっとくらい自分への褒美としていいだろ』う。", next: "r2_nikki55" }, 
    ...
    { id: "r2_nikki65", name: " ", text: "再検査の日が10...じゃない、20…でもないか…30…", portrait:{ who:"miya", face:"kind" }, next: "r2_nikki66" }, 
    ...
    { id: "r2_nikki72", name: "みや", text: "…ここで、日記は終わってますね。", portrait:{ who:"miya", face:"confuse" }, next: "r2_nikki73" }, 
    { id: "r2_nikki73", name: "あなた", text: "…なんだか、不穏な日記だな。", portrait:{ who:"miya", face:"confuse" }, next: "r2_nikki74" }, 
    ...
    { id: "r2_talk_tuning2", name: "みや", text: "そうですね…", portrait:{ who:"miya", face:"confuse" }, nextIfFlags: [
        { flags: ["r2_kagi"], next: "r2_nazotoki_hint" },
        { flags: [], next: "r2_nocomplete" }], next: "r2_nocomplete" },

    { id: "r2_nocomplete", name: "みや", text: "まだ、探せていない所があるかもしれません。", portrait:{ who:"miya", face:"normal" }, next: "r2_nocomplete2" },
    { id: "r2_nocomplete2", name: "みや", text: "もう一度探してみませんか?", portrait:{ who:"miya", face:"kind" }, next: "r2_nocomplete3" },
    { id: "r2_nocomplete3", name: "あなた", text: "なるほど…ありがとう!", portrait:{ who:"miya", face:"kind" }, next: "r2_hub" },

    { id: "r2_nazotoki_hint", name: "みや", text: "謎解きはちょっと見方を変えてみると分かりやすいかと…", portrait:{ who:"miya", face:"kind" }, next: "r2_nazotoki_hint2" },
    { id: "r2_nazotoki_hint2", name: "みや", text: "例えばですけど、イラストをアルファベットに置き換えてみるとか…", portrait:{ who:"miya", face:"kind" }, next: "r2_nazotoki_hint3" },
    { id: "r2_nazotoki_hint3", name: "みや", text: "実際に紙に書いてみると分かりやすいかもしれませんね", portrait:{ who:"miya", face:"kind" }, next: "r2_nazotoki_hint4" },
    { id: "r2_nazotoki_hint4", name: "あなた", text: "なるほど…ありがとう!!", portrait:{ who:"miya", face:"smile" }, next: "r2_hub" },
    ...
    { id: "r2_shiro", name: "あなた", text: "白い部屋に戻った。", set: { bg: "./Three_Doors.png" }, se:"door_open",  nextIfFlags: [
     ...
     { id: "r2_shiro_fin", name: "あなた", text: "白い部屋に戻った。", set: { bg: "./shiroi.png" }, se:"door_open", next: "fin_hub" },
    ...
    { id: "r2_candle1_gone4", name: "みや", text: "でも、一本だけのようですね…", portrait:{ who:"miya", face:"fear" }, next: "r2_candle1_gone5" },
    { id: "r2_candle1_gone5", name: "あなた", text: "もしかして、間違える度に、炎が消えるのか…?", portrait:{ who:"miya", face:"fear" }, next: "r2_candle1_gone6" },
    { id: "r2_candle1_gone6", name: "みや", text: "なるほど…その可能性が高いですね。",portrait:{ who:"miya", face:"confuse" },  next: "r2_candle1_gone7" },
    { id: "r2_candle1_gone7", name: "あなた", text: "だとすると、もし残り二回間違えたら…",portrait:{ who:"miya", face:"confuse" },  next: "r2_candle1_gone8" },
    { id: "r2_candle1_gone8", name: "みや", text: "炎が全て消える…だけで済むんでしょうか。", portrait:{ who:"miya", face:"fear" }, next: "r2_candle1_gone9" },
    ...
    { id: "r2_candle1_gone11", name: "みや", text: "す、すみません!変なこと考えてしまいました…!!",portrait:{ who:"miya", face:"fear" },  portrait:{ who:"miya", face:"fear" }, next: "r2_candle1_gone12" },
    { id: "r2_candle1_gone12", name: "あなた", text: "い、いや!自分も嫌な妄想をしてた…!", portrait:{ who:"miya", face:"fear" }, next: "r2_candle1_gone13" },
    { id: "r2_candle1_gone13", name: "あなた", text: "は、早く答えを見つければいいだけだもんね!!",portrait:{ who:"miya", face:"fear" },  next: "r2_candle1_gone14" },
    { id: "r2_candle1_gone14", name: "みや", text: "そ、そうですよね!!調べなおしましょう!", portrait:{ who:"miya", face:"kind" }, next: "r2_candle1_gone15" },
    ...
    { id: "r2_candle2_gone5", name: "みや", text: "…恐らく間違えていいのはあと一回だけです。", portrait:{ who:"miya", face:"fear" }, next: "r2_candle2_gone6" },
    { id: "r2_candle2_gone6", name: "みや", text: "頑張って答えを見つけましょう…!!", portrait:{ who:"miya", face:"kind" }, next: "r2_candle2_gone7" },
    { id: "r2_candle2_gone7", name: "あなた", text: "そうだな…",portrait:{ who:"miya", face:"kind" },  next: "r2_candle2_gone8" },
    ...
    { id: "r2_candle_all_off2", name: "みや", text: "いけない!!…最後の蠟燭が…!!",portrait:{ who:"miya", face:"confuse" },  next: "r2_candle_all_off3" },
    ...
    { id: "r2_candle_all_off19", name: "あなた", text: "…!!",portrait:{ who:"miya_bad", face:"tear" }, next: "r2_candle_all_off20" },
    { id: "r2_candle_all_off20", name: "みや(?)", text: "…っ…っ……っ…", portrait:{ who:"miya_bad", face:"tear" }, next: "r2_candle_all_off21" },
    { id: "r2_candle_all_off21", name: "あなた", text: "(白い部屋であったみやが…泣いてる?)", portrait:{ who:"miya_bad", face:"tear" }, next: "r2_candle_all_off22" },
    { id: "r2_candle_all_off22", name: "あなた", text: "(髪はぼさぼさで、刃物を持っていることは変わらない…)",portrait:{ who:"miya_bad", face:"tear" }, next: "r2_candle_all_off23" },
    ...
    { id: "r2_candle_all_off26", name: "???", text: "ふふっ…突然話しかけてごめんなさい。",overlay: { sprite: "./みや.mile.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "r2_candle_all_off27" },
    { id: "r2_candle_all_off27", name: "???", text: "こんにちは。はじめまして。",overlay: { sprite: "./みや.ormal.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "r2_candle_all_off28" },
    { id: "r2_candle_all_off28", name: "???", text: "あ、でも、ポスターを見てくれたなら、君は私をみたことあるかも。",overlay: { sprite: "./みや.ind.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "r2_candle_all_off29" },
    { id: "r2_candle_all_off29", name: "あなた", text: "君はーー。",overlay: { sprite: "./みや.ind.png", withText: true,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)" },next: "r2_candle_all_off30" },
    { id: "r2_candle_all_off30", name: "???", text: "私は、君の味方でも敵でもないの。だから、君のことを助けないし、殺しもしない。", overlay: { sprite: "./みや.ormal.png", withText: true,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)" }, next: "r2_candle_all_off31" },
    { id: "r2_candle_all_off31", name: "???", text: "けれど、君に夢を与えることは出来るんだよ。", overlay: { sprite: "./みや.ind.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "r2_candle_all_off32" },
    { id: "r2_candle_all_off32", name: "あなた", text: "(夢…?)",overlay: { sprite: "./みや.ind.png", withText: true,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)" }, next: "r2_candle_all_off33" },
    { id: "r2_candle_all_off33", name: "???", text: "…君もその子も、私の大好きなヒト。",overlay: { sprite: "./みや.mile.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "r2_candle_all_off34" },
    { id: "r2_candle_all_off34", name: "???", text: "ねぇ…もっと…", overlay: { sprite: "./みや.ormal.png", withText: true,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)" },next: "r2_candle_all_off35" },
    { id: "r2_candle_all_off35", name: "???", text: "私を楽しませて?", overlay: { sprite: "./みや.ind.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"},next: "r2_candle_all_off36" },
    ...
    { id: "r2_candle_all_off39", name: "みや", text: "…あれ?明かりが…",portrait:{ who:"miya", face:"fear" }, next: "r2_candle_all_off40" },
    { id: "r2_candle_all_off40", name: "あなた", text: "みや!!大丈夫だった…?", next: "r2_candle_all_off41" },
    { id: "r2_candle_all_off41", name: "みや", text: "はい…ずっと暗闇を彷徨ってましたが…",portrait:{ who:"miya", face:"kind" }, next: "r2_candle_all_off42" },
    { id: "r2_candle_all_off42", name: "みや", text: "明かりが戻ってますね…?",portrait:{ who:"miya", face:"fear" }, next: "r2_candle_all_off43" },
    { id: "r2_candle_all_off43", name: "あなた", text: "そうだね…一体どうして…?", portrait:{ who:"miya", face:"fear" },next: "r2_candle_all_off44" },
    { id: "r2_candle_all_off44", name: "みや", text: "…って、あれ!見てください!!", portrait:{ who:"miya", face:"normal" },next: "r2_candle_all_off45" },
    { id: "r2_candle_all_off45", name: "みや", text: "三味線ケースが…開いてます!!", portrait:{ who:"miya", face:"smile" },next: "r2_candle_all_off46" },
    ...
    { id: "r2_candles_relight4", name: "みや", text: "ですね...!!良かった…", portrait:{ who:"miya", face:"smile" }, next: "r2_candles_relight5" },
    { id: "r2_candles_relight5", name: "みや", text: "それに、ケースも開いてます!!", portrait:{ who:"miya", face:"kind" },next: "r2_candles_relight6" },
    { id: "r2_candles_relight6", name: "あなた", text: "中を確認してみるか", next: "r2_open_case" },

    // 通常オープン
    { id: "r2_open_normal", name: "みや", text: "開きました…!", portrait:{ who:"miya", face:"smile" }, next: "r2_open_normal2" },
    { id: "r2_open_normal2", name: "あなた", text: "やった!!", portrait:{ who:"miya", face:"kind" }, next: "r2_open_case" },

    // ケース内確認
    { id: "r2_open_case", name: " ", text: "ケースの中を恐る恐る覗く…", next: "r2_open_case2" },
    { id: "r2_open_case2", name: "みや", text: "三味線が…",portrait:{ who:"miya", face:"normal" }, next: "r2_open_case3" },
    { id: "r2_open_case3", name: "あなた", text: "ない!", next: "r2_open_case4" },
    { id: "r2_open_case4", set:{bgm:"forgot"} ,name: "みや", text: "空の三味線ケースだった...ということでしょうか?",portrait:{ who:"miya", face:"confuse" }, next: "r2_open_case5" },
    ...
    { id: "r2_open_case7", name: "みや", text: "…あれ?ちょっと待ってください!布の中になにか入ってます!",portrait:{ who:"miya", face:"normal" }, next: "r2_open_case8" },
    ...
    { id: "r2_open_case10", name: "あなた", text: "うん。さっきは緑だったけど、今度は赤色だ。", overlay: { sprite: "./RED.png", withText: true }, portrait:{ who:"miya", face:"normal" }, next: "r2_open_case11" },
    { id: "r2_open_case11", name: "あなた", text: "さらに毒々しくなってないか…?",  overlay: { sprite: "./RED.png", withText: true },next: "r2_open_case12" },
    { id: "r2_open_case12", name: "みや", text: "...もしかしたら、部屋ごとにこの瓶を集めていくんじゃないですか?", portrait:{ who:"miya", face:"normal" },next: "r2_open_case13" },
    { id: "r2_open_case13", name: "みや", text: "とはいっても、集めたあとにどうするのか分かっていないですけど…", portrait:{ who:"miya", face:"confuse" },next: "r2_open_case14" },
    ...
    { id: "r2_open_case17", name: "みや", text: "ある程度調べ終わったら、白い部屋に戻ってみませんか?",portrait:{ who:"miya", face:"normal" }, next: "r2_open_case18" },
    { id: "r2_open_case18", name: "みや", text: "何か変わっているかもしれません。",portrait:{ who:"miya", face:"kind" }, next: "r2_open_case19" },
    { id: "r2_open_case19", name: "あなた", text: "そうだね。",portrait:{ who:"miya", face:"kind" }, next: "r2_open_case20" },
    ...
    { id: "r2_read_rain24", name: "みや", text: "続きがあるかのような終わり方ですね…", portrait:{ who:"miya", face:"normal" }, next: "r2_read_rain25" },
    { id: "r2_read_rain25", name: "あなた", text: "もしかしたら参、肆...があるのかもしれないね。", portrait:{ who:"miya", face:"normal" }, next: "r2_read_rain26" },
    ...
    { id: "r2_read_rain28", name: " ", text: "情報:『小さな雫 -弐-』を手に入れた!", se: "infomation", set: { infoNotes:["shizuku_ni:content"] }, portrait:{ who:"miya", face:"normal" }, next: "r2_hub" },
    ...
    { id: "r2_bottle3", name: "みや", text: "うーん…", portrait:{ who:"miya", face:"confuse" }, next: "r2_bottle4" },
    { id: "r2_bottle4", name: "あなた", text: "そんなに悩んで、どうしたの?", portrait:{ who:"miya", face:"confuse" }, next: "r2_bottle5" },
    { id: "r2_bottle5", name: "みや", text: "あの…どこからか音が聞こえませんか?",  portrait:{ who:"miya", face:"normal" },next: "r2_bottle6" },
    { id: "r2_bottle6", name: "あなた", text: "音?どんな?", portrait:{ who:"miya", face:"normal" }, next: "r2_bottle7" },
    { id: "r2_bottle7", name: "みや", text: "弦を弾く…感じですかね。私の気のせいかもしれないですけど…",  portrait:{ who:"miya", face:"fear" },next: "r2_bottle8" },
    { id: "r2_bottle8", name: "あなた", text: "(あれ…この流れどっかであった気がするぞ?)", portrait:{ who:"miya", face:"fear" }, next: "r2_bottle9" },
    { id: "r2_bottle9", name: "あなた", text: "…し、視線じゃなくて?", portrait:{ who:"miya", face:"fear" }, next: "r2_bottle10" },
    { id: "r2_bottle10", name: "みや", text: "視線じゃないです!それにさっきよりも悪意みたいなの感じにくいですし…", portrait:{ who:"miya", face:"confuse" }, next: "r2_bottle11" },
    { id: "r2_bottle11", name: "あなた", text: "(みやは反応しなかったけど、自分は金縛りにあったんだよな…)", portrait:{ who:"miya", face:"confuse" }, next: "r2_bottle12" },
    { id: "r2_bottle12", name: "みや", text: "とにかく、一回耳を立ててみてください!絶対聞こえるはずです!!", portrait:{ who:"miya", face:"kind" }, next: "r2_bottle13" },
    { id: "r2_bottle13", name: "あなた", text: "えぇ…、わかったよ…", portrait:{ who:"miya", face:"kind" }, next: "r2_bottle14" },
    { id: "r2_bottle14", name: " ", text: "", se:"sanngenn", next: "r2_bottle15" },
    { id: "r2_bottle15", name: "あなた", text: "…本当だ、音が聞こえる。",  next: "r2_bottle16" },
    { id: "r2_bottle16", name: "みや", text: "ほら!やっぱり!", portrait:{ who:"miya", face:"smile" }, next: "r2_bottle17" },
    { id: "r2_bottle17", name: "あなた", text: "…しかもこれ、三味線の音だ。", portrait:{ who:"miya", face:"smile" }, next: "r2_bottle18" },
    { id: "r2_bottle18", name: "みや", text: "なるほど…でもどこから鳴っているんでしょう…?この部屋に来たときは鳴っていなかったと思います。", portrait:{ who:"miya", face:"normal" }, next: "r2_bottle19" },
    ...
    { id: "r2_hazure", name: "みや", text: "流石に…それは…違くないですか?", portrait:{ who:"miya", face:"fear" }, next: "r2_hazure2" },
    { id: "r2_hazure2", name: "みや", text: "耳を当てても聞こえないです", portrait:{ who:"miya", face:"confuse" }, next: "r2_hazure3" },
    ...
    { id: "r2_bottle22", name: "みや", text: "これ…ですか?ちょっと借りてもいいですか?", portrait:{ who:"miya", face:"normal" }, next: "r2_bottle23" },
    { id: "r2_bottle23", name: "あなた", text: "勿論!どうぞ。", portrait:{ who:"miya", face:"normal" }, next: "r2_bottle24" },
    { id: "r2_bottle24", name: "みや", text: "…!これです!私が聞こえた音!", portrait:{ who:"miya", face:"smile" }, next: "r2_bottle25" },
    { id: "r2_bottle25", name: "あなた", text: "よかった…", portrait:{ who:"miya", face:"smile" }, next: "r2_bottle26" },
    { id: "r2_bottle26", name: "あなた", text: "(部屋に入ってから聞いてないってことは、部屋に入った時にはそこになかったか、遠隔で操作されているか、)", portrait:{ who:"miya", face:"normal" }, next: "r2_bottle27" },
    { id: "r2_bottle27", name: "あなた", text: "(あるいは、音が聞こえないような環境に置かれているか。)", portrait:{ who:"miya", face:"normal" }, next: "r2_bottle28" },
    { id: "r2_bottle28", name: "あなた", text: "三味ケースって分厚いから小さい音なら聞こえなくなるのかな…って思って。", portrait:{ who:"miya", face:"normal" }, next: "r2_bottle29" },
    { id: "r2_bottle29", name: "みや", text: "なるほど…流石です!", portrait:{ who:"miya", face:"kind" }, next: "r2_bottle30" },
    { id: "r2_bottle30", name: "みや", text: "でも、液体瓶から音…ということは?", portrait:{ who:"miya", face:"normal" }, next: "r2_bottle31" },
    { id: "r2_bottle31", name: "あなた", text: "箏の部屋で手に入った瓶も聞こえるんじゃないか…であってる?", portrait:{ who:"miya", face:"normal" }, next: "r2_bottle32" },
    { id: "r2_bottle32", name: "みや", text: "…お見事!!完全に読まれてしまいましたね。", portrait:{ who:"miya", face:"smile" }, next: "r2_bottle33" },
    { id: "r2_bottle33", name: "あなた", text: "試しにきいてみよっか...",next: "r2_bottle34" },
    { id: "r2_bottle34", name: " ", text: "",se:"KT", next: "r2_bottle35" },
    { id: "r2_bottle35", name: "みや", text: "これも音が聞こえます…!!", portrait:{ who:"miya", face:"smile" }, next: "r2_bottle36" },
    { id: "r2_bottle36", name: "あなた", text: "これは…箏の音…かな?", portrait:{ who:"miya", face:"normal" }, next: "r2_bottle37" },
    ...
    { id: "r2_bottle40", name: "みや", text: "やっぱり流石ですね…私も、もっと頑張らないと…!!", portrait:{ who:"miya", face:"kind" }, next: "r2_bottle41" },
    { id: "r2_bottle41", name: "あなた", text: "(役に立った感じがして、ちょっと嬉しい…)", portrait:{ who:"miya", face:"kind" }, next: "r2_bottle42" },
    { id: "r2_bottle42", name: " ", text: "情報:『謎の液体(赤)』の内容が更新されました!",se: "infomation",  portrait:{ who:"miya", face:"normal" }, 
    ...
    { id: "r2_talking2", name: "みや", text: "暗いところは大丈夫ですよ", portrait:{ who:"miya", face:"normal" }, next: "r2_talking3" },
    { id: "r2_talking3", name: "みや", text: "一体どうして、そんなこと…?", portrait:{ who:"miya", face:"confuse" }, next: "r2_talking4" },
    { id: "r2_talking4", name: "あなた", text: "いや、閉所恐怖症とかありえるじゃん。", portrait:{ who:"miya", face:"confuse" }, next: "r2_talking5" },
    { id: "r2_talking5", name: "あなた", text: "もしみやが、何か抱えてて、忘れていたりしたら、大丈夫かな…っていう", portrait:{ who:"miya", face:"confuse" }, next: "r2_talking6" },
    { id: "r2_talking6", name: "みや", text: " 成程…!心配してくれてありがとうございます。", portrait:{ who:"miya", face:"kind" }, next: "r2_talking7" },
    { id: "r2_talking7", name: "あなた", text: "それならよかったよ。", portrait:{ who:"miya", face:"kind" }, next: "r2_talking8" },
    { id: "r2_talking8", name: "あなた", text: "…ん?さっき「暗い所”は”」って言ったよね?。", portrait:{ who:"miya", face:"kind" }, next: "r2_talking9" },
    { id: "r2_talking9", name: "あなた", text: "もしかして、何か他で苦手なことでも…?", portrait:{ who:"miya", face:"kind" }, next: "r2_talking10" },
    { id: "r2_talking10", name: "みや", text: "あはは…よく気づきましたね。", portrait:{ who:"miya", face:"normal" }, next: "r2_talking11" },
    { id: "r2_talking11", name: "みや", text: "私、ただ暗いだけなら大丈夫なんですけど…", portrait:{ who:"miya", face:"confuse" }, next: "r2_talking12" },
    { id: "r2_talking12", name: "みや", text: "こういう場所とか特に…出そうだな…と", portrait:{ who:"miya", face:"fear" }, next: "r2_talking13" },
    { id: "r2_talking13", name: "あなた", text: "出そう…?", portrait:{ who:"miya", face:"fear" }, next: "r2_talking14" },
    { id: "r2_talking14", name: "みや", text: "その...お、お化けが…", portrait:{ who:"miya", face:"confuse" }, next: "r2_talking15" },
    { id: "r2_talking15", name: "あなた", text: "な、なるほど…", portrait:{ who:"miya", face:"confuse" }, next: "r2_talking16" },
    { id: "r2_talking16", name: "あなた", text: "(みやがお化け苦手なの、ちょっと意外かも…)", portrait:{ who:"miya", face:"confuse" }, next: "r2_talking17" },
    { id: "r2_talking17", name: "みや", text: "…今、馬鹿にしましたか…?", portrait:{ who:"miya", face:"fear" }, next: "r2_talking18" },
    { id: "r2_talking18", name: "あなた", text: "してないしてない!!みやの思い込みだよ…!!", portrait:{ who:"miya", face:"fear" }, next: "r2_talking19" },
