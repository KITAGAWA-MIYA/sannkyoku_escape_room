...
window.STORY_R3 = {
  ...
  nodes: [
    ...
    { id: "r3_from_intro4", name: "みや", text: "シャンデリアがあるので、外ではなさそうですね。",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r3_from_intro5" },
    { id: "r3_from_intro5", name: "みや", text: "もしかして、この竹の壁って壁紙だったりします?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_from_intro6" },
    { id: "r3_from_intro6", name: "あなた", text: "凄い…精巧に作られてる。",portrait:{ who:"miya", face:"kind", size:"500px" },nextIfFlags: [
    ...
    { id: "r3_from_intro7_2", name: "あなた", text: "そういえば、三味線の部屋にもよく作られた障子の壁紙がありましたね",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r3_from_intro7_3" },
    { id: "r3_from_intro7_3", name: "あなた", text:"え、そんなのあったの?全然気づかなかった…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r3_from_intro8" },
    ...
    { 
      ...
      explore: {
        ...
        talk: { sprite: "./みや.stand.png", x: "58%", y: "72%", size: "270px", next: "r3_talk1" }
      }
    },

    // 尺八ショーケース
    { id: "r3_shakuhachi", name: " ", text: "部屋の中央には豪華なショーケースが置かれている。", next: "r3_shakuhachi2" },
    { id: "r3_shakuhachi2", name: "みや", text: "これは、尺八…ですか?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_shakuhachi3" },
    { id: "r3_shakuhachi3", name: "あなた", text: "うん…多分尺八…だと思う。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_shakuhachi4" },
    ...
    { id: "r3_shakuhachi6", name: "みや", text: "うーん、やはり各部屋和楽器をイメージされてるんですね。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_shakuhachi7" },
    { id: "r3_shakuhachi7", name: "あなた", text: "そうだね、それも三曲研究部に全部関わりがある和楽器だ。", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r3_shakuhachi8" },
    { id: "r3_shakuhachi8", name: "みや", text: "え!?尺八を吹いてる方もいるんですか!?凄いですね!!",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r3_shakuhachi9" },
    { id: "r3_shakuhachi9", name: "みや", text: "演奏とかはそれぞれ楽器ごとって感じなんですか?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_shakuhachi10" },
    { id: "r3_shakuhachi10", name: "あなた", text: "それぞれで演奏するときもあるけど、基本は合奏形態かな。", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r3_shakuhachi11" },
    { id: "r3_shakuhachi11", name: "みや", text: "合奏...かっこいいですね!", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r3_shakuhachi12" },
    { id: "r3_shakuhachi12", name: "あなた", text: "そ、そうかな……あの、話が急に変わるんだけど、さっきからショーケースペタペタ触って何してるの?",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r3_shakuhachi13" },
    { id: "r3_shakuhachi13", name: "みや", text: "あ!!開けられるところがないか調べてたんです。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_shakuhachi14" },
    { id: "r3_shakuhachi14", name: "みや", text: "中にある尺八を取り出せないかなと…", portrait:{ who:"miya", face:"kind", size:"500px" },next: "r3_shakuhachi15" },
    { id: "r3_shakuhachi15", name: "みや", text: "でも、何処にも扉がないんですけどね…", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r3_shakuhachi16" },
    { id: "r3_shakuhachi16", name: "あなた", text: "ショーケースの扉がない…?でも尺八が入ってるってことは、どこかに開閉できる場所がある筈だよね…", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r3_shakuhachi17" },
    { id: "r3_shakuhachi17", name: "みや", text: "うーん…そうなんですよね…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r3_shakuhachi18" },
    { id: "r3_shakuhachi18", name: "みや", text: "私、もう少しショーケース周り調べてみます。なのであなたはその他の場所をお願いしてもいいですか?", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r3_shakuhachi19" },
    { id: "r3_shakuhachi19", name: "あなた", text: "分かった!他にも調べられそうな所がないかみてみるよ。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_shakuhachi20" },
   ...
   { id: "r3_covering_shou1", name: "あなた", text: "穴は塞がっている", choices: [
    ...
    { id: "r3_bad_song1", name: "みや", text: "この音は…一体…", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "r3_bad_song2_5" },
    ...
    { id: "r3_bad_song5", name: "みや", text: "そ、そうか、床が土だから…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r3_bad_song6" },
    { id: "r3_bad_song6", name: "あなた", text: "ま、まずい…!!!",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "r3_bad_song7" },
    ...
    { id: "r3_bad_song9", name: "みや", text: "うぅ…口の中に砂が…", portrait:{ who:"miya", face:"fear", size:"500px" },next: "r3_bad_song10" },
    { id: "r3_bad_song10", name: "みや", text: "それに、全身に土埃が直撃して…若干痛いです…",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r3_bad_song11" },
    ...
    { id: "r3_open_showcase2", name: "みや", text: "はい、どうしましたか?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_open_showcase3" },
    ...
    { id: "r3_open_showcase6", name: "みや", text: "あ———!!!それです———!!!!!", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r3_open_showcase7" },
    { id: "r3_open_showcase7", name: "あなた", text: "おぉ…び、びっくりした…",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r3_open_showcase8" },
    { id: "r3_open_showcase8", name: "みや", text: "あ…突然大きい声を出してすみません…", portrait:{ who:"miya", face:"fear", size:"500px" },next: "r3_open_showcase9" },
    { id: "r3_open_showcase9", name: "みや", text: "でも、これで開くと思います!",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r3_open_showcase10" },
    { id: "r3_open_showcase10", name: "あなた", text: "そっか…よかった。",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r3_open_showcase11" },
    { id: "r3_open_showcase11", name: "あなた", text: "ちなみに、どこにかざすの…?",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r3_open_showcase12" },
    { id: "r3_open_showcase12", name: "みや", text: "恐らく、ここかと…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_open_showcase13" },
    { id: "r3_open_showcase13", name: "あなた", text: "え、ショーケースの下…!?", next: "r3_open_showcase14" },
    { id: "r3_open_showcase14", name: "みや", text: "はい、ここにQRコードを読み取る機械が置かれてありまして…",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r3_open_showcase15" },
    ...
    { id: "r3_open_showcase18", name: "みや", text: "あ!開いたみたいです!!",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_open_showcase19" },
    { id: "r3_open_showcase19", name: "あなた", text: "確に空きました!!みたいな音はしたけど…扉はどこに?", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r3_open_showcase20" },
    { id: "r3_open_showcase20", name: "みや", text: "扉は上にあります!!", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r3_open_showcase21" },
    { id: "r3_open_showcase21", name: "あなた", text: "う、上なんだ…", portrait:{ who:"miya", face:"smile", size:"500px" },next: "r3_open_showcase22" },
    { id: "r3_open_showcase22", name: "みや", text: "早速取り出してみますか?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_open_showcase23" },
    { id: "r3_open_showcase23", name: "あなた", text: "うーん…取り出したいけど…結構高いよ?", portrait:{ who:"miya", face:"normal", size:"500px" },next: "r3_open_showcase24" },
    { id: "r3_open_showcase24", name: "あなた", text: "多分よじ登らないと取り出せない気が…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_open_showcase25" },
    { id: "r3_open_showcase25", name: "みや", text: "大丈夫です!先ほど、三味線の部屋から登れる台を持ってきたので、取り出せると思います!",portrait:{ who:"miya", face:"smile", size:"500px" },  next: "r3_open_showcase26" },
    { id: "r3_open_showcase26", name: "あなた", text: "(よ、用意周到だ…!!)",portrait:{ who:"miya", face:"smile", size:"500px" },  next: "r3_open_showcase27" },
    ...
    { id: "r3_open_showcase32", name: "みや", text: "…目の錯覚かなんかを利用して、ショーケースの中に尺八があるかのように見せているのでしょうか?",portrait:{ who:"miya", face:"confuse", size:"500px" },  next: "r3_open_showcase33" },
    { id: "r3_open_showcase33", name: "みや", text: "でも、一体どういう仕組みで…",portrait:{ who:"miya", face:"fear", size:"500px" },  next: "r3_open_showcase34" },
    { id: "r3_open_showcase34", name: "あなた", text: "さっぱり分からないけど、とにかく騙されたってこと…?",portrait:{ who:"miya", face:"fear", size:"500px" },  next: "r3_open_showcase35" },
    { id: "r3_open_showcase35", name: "みや", text: "そういうことになりますね…",portrait:{ who:"miya", face:"confuse", size:"500px" },  next: "r3_open_showcase36" },
    { id: "r3_open_showcase36", name: "あなた", text: "うぁ…まじか…",portrait:{ who:"miya", face:"confuse", size:"500px" },  next: "r3_open_showcase37" },
    { id: "r3_open_showcase37", name: "みや", text: "あれ…?でも中に何か入ってるみたいですよ。", portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_open_showcase38" },
    ...
    { id: "r3_open_showcase45", name: "みや", text: "そうですね…",portrait:{ who:"miya", face:"normal", size:"500px" },  next: "r3_open_showcase46" },
    { id: "r3_open_showcase46", name: "みや", text: "ある程度、この部屋を探索し終わったら、白い部屋に戻ってみますか?", portrait:{ who:"miya", face:"kind", size:"500px" }, next: "r3_open_showcase47" },
    { id: "r3_open_showcase47", name: "みや", text: "なにか変わっている所があるかもしれません。",portrait:{ who:"miya", face:"normal", size:"500px" },  next: "r3_open_showcase48" },
    { id: "r3_open_showcase48", name: "あなた", text: "そうだな…一度戻ってみるのもありなのかもしれない。", portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_open_showcase49" },
    ...
    { id: "r3_encourage2", name: "みや", text: "そうですね…",portrait:{ who:"miya", face:"confuse", size:"500px" },  nextIfFlags: [
        { flags: ["r3_nazo_2"], next: "r3_bushu" },
        { flags: [], next: "r3_encourage3" }], next: "r3_encourage3" },
    { id: "r3_encourage3", name: "みや", text: "まだ探索しきれていない箇所がありそうです。",portrait:{ who:"miya", face:"kind", size:"500px" },  next: "r3_encourage4" },
    { id: "r3_encourage4", name: "みや", text: "そこを確認すると、何か情報が得られるかもしれません。",portrait:{ who:"miya", face:"normal", size:"500px" },  next: "r3_encourage5" },
    { id: "r3_encourage5", name: "あなた", text: "ありがとう!もう少し探してみる!", next: "r3_hub" },

    { id: "r3_bushu", name: "みや", text: "漢字からカタカナを連想する…ですか。",portrait:{ who:"miya", face:"normal", size:"500px" },  next: "r3_bushu2" },
    { id: "r3_bushu2", name: "みや", text: "あくまで一案なんですけど、一つカタカナを足した時、〇の漢字だと成立するけど、×だと成立しない…みたいな?",portrait:{ who:"miya", face:"kind", size:"500px" },  next: "r3_bushu3" },
    { id: "r3_bushu3", name: "みや", text: "例えば「本」に「イ」を足したら「体」になるというような感じです!…今回、本はないですけど…", portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_bushu4" },
    { id: "r3_bushu4", name: "みや", text: "もしこの部屋の情報でカタカナが出てきたら、その文字が怪しいかもしれませんね",portrait:{ who:"miya", face:"smile", size:"500px" },  next: "r3_bushu5" },
    { id: "r3_bushu5", name: "みや", text: "なるほど…ありがとう!",portrait:{ who:"miya", face:"smile", size:"500px" },  next: "r3_hub" },
   

    // みやとの雑談(テーマ:独り言)
    { id: "r3_talk_chat1", name: "あなた", text: "うーん…ここじゃないのか…",portrait:{ who:"miya", face:"confuse", size:"500px" },  next: "r3_talk_chat2" },
    ...
    { id: "r3_talk_chat5", name: "みや", text: "うーん、これは…随分と近未来な予感。",portrait:{ who:"miya", face:"normal", size:"500px" },  next: "r3_talk_chat6" },
    { id: "r3_talk_chat6", name: "あなた", text: "み、みや…", portrait:{ who:"miya", face:"normal", size:"500px" }, next: "r3_talk_chat7" },
    ...
    { id: "r3_talk_chat10", name: "みや", text: "お恥ずかしい所をお見せしました…", portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r3_talk_chat11" },
    { id: "r3_talk_chat11", name: "あなた", text: "いや…自分も独り言言っちゃうタイプだから…気持ち分かるよ。", portrait:{ who:"miya", face:"smile", size:"500px" }, next: "r3_talk_chat12" },
    ...
    { id: "r3_talk_chat15", name: "あなた", text: "…今気づいたけど、一人称”私”になってるね。",portrait:{ who:"miya", face:"fear", size:"500px" },  next: "r3_talk_chat16" },
    { id: "r3_talk_chat16", name: "みや", text: "...?もしかして、一人称違ったんですか…?",portrait:{ who:"miya", face:"normal", size:"500px" },  next: "r3_talk_chat17" },
    ...
    { id: "r3_talk_chat20", name: "みや", text: "うーん…そこは戻らなくていいかもです…", portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "r3_talk_chat21" },
