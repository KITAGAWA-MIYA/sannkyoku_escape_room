...
window.STORY_FIN = {
  ...
  nodes: [
    ...
    { id: "fin_hidden_end26", name: "あなた", text: "…動いてる?",overlay: { sprite: "./miya.ormal.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end27" },
    { id: "fin_hidden_end27", name: "???", text: "「あ…やっと気づいた?」",overlay: { sprite: "./miya.mile.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end28" },
    { id: "fin_hidden_end28", name: "???", text: "「君たちのこと、ここからずっと見させてもらってたよ。」",overlay: { sprite: "./miya.ormal.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"},  next: "fin_hidden_end29" },
    { id: "fin_hidden_end29", name: "???", text: "「私は、君たちには期待していたんだけどな…きっといい演奏してくるって。」", overlay: { sprite: "./miya.shock.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end30" },
    { id: "fin_hidden_end30", name: "???", text: "「それなのに……君たちは君たち自身で演奏を台無しにした。」",overlay: { sprite: "./miya.angry.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end31" },
    { id: "fin_hidden_end31", name: "???", text: "「今回は期待はずれだったかな?」", overlay: { sprite: "./miya.ind.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"} ,next: "fin_hidden_end32" },
    { id: "fin_hidden_end32", name: "???", text: "「君たちは、私の時間を期待を、想いを無駄にした。」",overlay: { sprite: "./miya.angry.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end33" },
    { id: "fin_hidden_end33", name: "???", text: "「どうやら、君たちには…」",overlay: { sprite: "./miya.ind.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"},  next: "fin_hidden_end34" },
    { id: "fin_hidden_end34", name: "???", text: "「…お仕置きが必要そうだね」",overlay: { sprite: "./miya.magic.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"},  next: "fin_hidden_end35" },
    ...
    { id: "fin_hidden_end65", name: "???", text: "…二人がどうなったのかって?", overlay: { sprite: "./miya.ormal.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end66" },
    { id: "fin_hidden_end66", name: "???", text: "あれ?…どうして、君があの子たちのことを覚えているの?",overlay: { sprite: "./miya.angry.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"},  next: "fin_hidden_end67" },
    { id: "fin_hidden_end67", name: "???", text: "おかしいな…みんなの記憶から消してあげたんだけど。",overlay: { sprite: "./miya.shock.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"},  next: "fin_hidden_end68" },
    ...
    { id: "fin_hidden_end69", name: "???", text: "すぐ、分からなくしてあげるから", se:"magic",overlay: { sprite: "./miya.mile.jpeg", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end_final" },
