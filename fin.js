...
window.STORY_FIN = {
  ...
  nodes: [
    ...
    { id: "fin_medicine_complete7", name: "みや", text: "っ!!凄い…!!綺麗な白色ですね…",portrait:{ who:"みや", face:"smile", size:"500px" }, next: "fin_medicine_complete8" },
    ...
    { id: "fin_medicine_complete15", name: "みや", text: "その白い薬なんですけど…", portrait:{ who:"みや", face:"normal", size:"500px" },next: "fin_medicine_complete16" },
    ...
    { id: "fin_medicine_complete18", name: "みや", text: "はい!先程から、その白い液体から美味しそうな匂いを感じて…",portrait:{ who:"みや", face:"kind", size:"500px" }, next: "fin_medicine_complete19" },
    ...
    { id: "fin_normal_end10", name: "あなた", text: "…味とかどうなの?見た目は完全に牛乳だけど…",portrait:{ who:"みや", face:"fear", size:"500px" }, next: "fin_normal_end11" },
    ...
    { id: "fin_normal_end13", name: "みや", text: "凄く飲みやすくなった飲むヨーグルトって感じです。",portrait:{ who:"みや", face:"kind", size:"500px" }, next: "fin_normal_end14" },
    ...
    { id: "fin_true_end18", name: "みや", text: "……!!美味しい!!飲むヨーグルトみたいで飲みやすいです!!",portrait:{ who:"みや", face:"smile", size:"500px" }, next: "fin_true_end20" },
    ...
    { id: "fin_true_end64", name: "みや", text: "まだ寝ぼけてそうだったから、起こしてやろうと思って", portrait:{ who:"みや", face:"kind", size:"500px" },next: "fin_true_end65" },
    ...
    { id: "fin_hidden_end26", name: "あなた", text: "…動いてる?", portrait:{ who:"みや", face:"ormal", size:"500px" },next: "fin_hidden_end27" },
