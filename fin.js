...
window.STORY_FIN = {
  ...
  chars:{
    ...
    みや_bad:{ 
      ...
      faces:{ 
        normal:"みや.狂.png", 
        angry:"みや.angry.狂.png", 
        tear:"みや.tear.狂.png", 
        smile:"みや.smile.狂.png"
      } 
    }
  },
  ...
  nodes: [
    ...
    { id: "fin_from_r3_4", name: "みや", text: "いや…違ったと思います。",portrait:{ who:"miya", face:"confuse", size:"500px" },  next: "fin_from_r3_5" },
    { id: "fin_from_r3_5", name: "みや", text: "家具は机しかなかったはずですし…", portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_from_r3_6" },
    { id: "fin_from_r3_6", name: "みや", text: "脱出に向けて着実に進んでるってことでしょうか…?",portrait:{ who:"miya", face:"kind", size:"500px" },  next: "fin_from_r3_7" },
    ...
    { id: "fin_from_r3_9", name: "みや", text: "この部屋スピーカーないですよね…",portrait:{ who:"miya", face:"confuse", size:"500px" },  next: "fin_from_r3_10" },
    ...
    { id: "fin_from_r3_16", name: "みや", text: "準備…もしかして…最後の謎解きでしょうか…?", portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_from_r3_17" },
    ...
    { 
      ...
      explore: {
        ...
        talk: { sprite: "./みや.stand.png", x: "72%", y: "72%", size: "270px", next: "fin_talk1" }
      }
    },
    ...
    { id: "fin_look_book19", name: "みや", text: "お母さまがどうなったか分からないのが…後味が悪いというか…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "fin_look_book20" },
    ...
    { id: "fin_look_saidann2", name: "あなた", text: "最初来た時、こんなもの置かれていなかったですよね…",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_look_saidann3" },
    { id: "fin_look_saidann3", name: "あなた", text: "うん。机だけだったはず…", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "fin_look_saidann4" },
    { id: "fin_look_saidann4", name: "あなた", text: "私達がこの部屋を離れている間に一体何が……",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "fin_look_saidann5" },
    { id: "fin_look_saidann5", name: "あなた", text: "とりあえず、机に何があるか確認してみよう。",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "fin_look_saidann6" },
    { id: "fin_look_saidann6", name: "あなた", text: "そうですね…", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_look_saidann_again" },
    ...
    { id: "fin_look_shashinntate_あなた2", name: "みや", text: "本当ですね!ここにもいるなんて…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_look_shashinntate3" },
    { id: "fin_look_shashinntate_みや", name: "みや", text: "この子…掛け軸の裏にあったポスターの女の子じゃ…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_look_shashinntate_みや2" },
    { id: "fin_look_shashinntate_みや2", name: "あなた", text: "女の子…?そんなのあったっけ?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_look_shashinntate_みや3" },
    { id: "fin_look_shashinntate_みや3", name: "みや", text: "箱の部屋の掛け軸の裏にこの女の子のポスターがあるんです!もしよければ、確認してみて下さい‼",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_look_shashinntate3" },
    { id: "fin_look_shashinntate3", name: "みや", text: "この女の子も何かと関わってくるのでしょうか…?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_look_shashinntate4" },
    ...
    { id: "fin_look_shashinntate6", name: "みや", text: "どうかしましたか?", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_look_shashinntate7" },
    { id: "fin_look_shashinntate7", name: "あなた", text: "いや、何でもない…多分疲れてるだけだと思うから。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_look_shashinntate8" },
    ...
    //調合開始
    { id: "fin_ready_medicine", name: "みや", text: "私達がやらなくちゃいけないことは…恐らく...", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_start_medicine4" },
    { id: "fin_start_medicine4", name: "あなた", text: "調合すること...だよな。", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_start_medicine5" },
    ...
    { id: "fin_medicine_complete2", name: "あなた", text: "混ぜ終わった液体の色は、白───", next: "fin_medicine_complete3" },
    { id: "fin_medicine_complete3", name: "あなた", text: "白い液体からは小さくはあるものの、箏・三味線・尺八の綺麗な三重奏が聞こえる。", next: "fin_medicine_complete4" },
    ...
    { id: "fin_medicine_complete6", name: "みや", text: "出来ましたか…?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_medicine_complete7" },
    { id: "fin_medicine_complete7", name: "みや", text: "っ!!凄い…!!綺麗な白色ですね…",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_medicine_complete8" },
    { id: "fin_medicine_complete8", name: "あなた", text: "ふふ…まるで雪みたい。", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_medicine_complete9" },
    { id: "fin_medicine_complete9", name: "みや", text: "それで…それを私達が飲む…で合ってましたっけ?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_medicine_complete10" },
    { id: "fin_medicine_complete10", name: "あなた", text: "うん、自分達が演奏者だとすれば、二人で分け合わないといけないと思う。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_medicine_complete11" },
    { id: "fin_medicine_complete11", name: "みや", text: "あの…突然なんですけど、",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_medicine_complete12" },
    { id: "fin_medicine_complete12", name: "みや", text: "あなたに、お願いがあって…", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_medicine_complete13" },
    { id: "fin_medicine_complete13", name: "あなた", text: "お願い……?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_medicine_complete14" },
    { id: "fin_medicine_complete14", name: "みや", text: "はい!お願いです!", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_medicine_complete15" },
    { id: "fin_medicine_complete15", name: "みや", text: "その白い薬なんですけど…", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_medicine_complete16" },
    { id: "fin_medicine_complete16", name: "みや", text: "私から飲んでもいいですか…?",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_medicine_complete17" },
    { id: "fin_medicine_complete17", name: "あなた", text: "みやから───?", next: "fin_medicine_complete18" },
    { id: "fin_medicine_complete18", name: "みや", text: "はい!先程から、その白い液体から美味しそうな匂いを感じて…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_medicine_complete19" },
    { id: "fin_medicine_complete19", name: "みや", text: "その…涎が止まらなくなってしまって…",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_medicine_complete20" },
    { id: "fin_medicine_complete20", name: "あなた", text: "…みや?",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_medicine_complete21" },
    { id: "fin_medicine_complete21", name: "みや", text: "とにかく、早く飲みたいんです…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "fin_medicine_complete22" },
    { id: "fin_medicine_complete22", name: "みや", text: "盃の中身の半分を飲んでお渡しするので、私から飲んでもいいですか…?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_medicine_complete23" },
    ...
    { id: "fin_count1", name: "みや", text: "分かりました…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_count1_2" },
    { id: "fin_count1_2", name: "あなた", text: "……",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_count1_3" },
    { id: "fin_count1_3", name: "あなた", text: "……", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_count1_4" },
    { id: "fin_count1_4", name: "みや", text: "……まだですか?", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "fin_count1_5" },
    { id: "fin_count1_5", name: "みや", text: "早く渡して下さい!", portrait:{ who:"miya", face:"fear", size:"500px" },next: "fin_medicine_complete27" },
    { id: "fin_medicine_complete27", name: "あなた", text: "みやに渡す...?", choices: [
        { label: "渡す", next: "fin_normal_end" },
        { label: "ちょっと考えたい。", next: "fin_count2" },
        { label: "渡さない", next: "fin_true_end", requires: { flags: ["r2_day_book_seen", "r3_voice_recording"] } }
      ]},
    { id: "fin_count2", name: "みや", text: "分かりました…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_count2_2" },
    { id: "fin_count2_2", name: "あなた", text: "……",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_count2_3" },
    { id: "fin_count2_3", name: "あなた", text: "……", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_count2_4" },
    { id: "fin_count2_4", name: "みや", text: "……まだですか?", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "fin_count2_5" },
    { id: "fin_count2_5", name: "みや", text: "早く渡して下さい!", portrait:{ who:"miya", face:"fear", size:"500px" },next: "fin_medicine_complete28" },
    ...
    { id: "fin_normal_end5", name: "みや", text: "やった!ふふ...ありがとうございます!", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_normal_end6" },
    { id: "fin_normal_end6", name: "あなた", text: "半分飲み終わったら、こっちにも頂戴。", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_normal_end7" },
    { id: "fin_normal_end7", name: "みや", text: "勿論です!すぐ飲んじゃうのでちょっと待っててくださいね。",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end8" },
    { id: "fin_normal_end8", name: " ", text: "みやはそう言うと、盃に口を当てる。",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end9" },
    { id: "fin_normal_end9", name: "みや", text: "…!!", portrait:{ who:"miya", face:"fear", size:"500px" },next: "fin_normal_end10" },
    { id: "fin_normal_end10", name: "あなた", text: "…味とかどうなの?見た目は完全に牛乳だけど…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "fin_normal_end11" },
    { id: "fin_normal_end11", name: "みや", text: "美味しい…凄く美味しいです!!", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_normal_end12" },
    { id: "fin_normal_end12", name: "あなた", text: "お、美味しいんだ…", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_normal_end13" },
    { id: "fin_normal_end13", name: "みや", text: "凄く飲みやすくなった飲むヨーグルトって感じです。",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end14" },
    { id: "fin_normal_end14", name: "みや", text: "ふふふ...もっと飲みたい…",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_normal_end15" },
    ...
    { id: "fin_normal_end19", name: "みや", text: "そうですね…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_normal_end20" },
    { id: "fin_normal_end20", name: "みや", text: "でも、あとちょっとだけ...",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_normal_end21" },
    { id: "fin_normal_end21", name: "みや", text: "ごくごく…ふふふ...美味しい。…まだ足りない。",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end22" },
    { id: "fin_normal_end22", name: "あなた", text: "み、みや?そろそろ───",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end23" },
    { id: "fin_normal_end23", name: "みや", text: "もっと、もっと…", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_normal_end24" },
    ...
    { id: "fin_normal_end27", name: "みや", text: "…五月蠅い!!!",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "fin_normal_end28" },
    { id: "fin_normal_end28", name: "あなた", text: "ッ!?", portrait:{ who:"miya", face:"fear", size:"500px" },next: "fin_normal_end29" },
    { id: "fin_normal_end29", name: "みや", text: "ちゃんと半分残せばいいんですよね?ちゃんとわかってますから!",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end30" },
    { id: "fin_normal_end30", name: "あなた", text: "いや、もう盃の中身半分も残ってないよ…それでいいから、こっちに…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end31" },
    { id: "fin_normal_end31", name: "みや", text: "…あれ?本当ですね。半分も残ってない...?失敗しちゃいましたね…",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_normal_end32" },
    { id: "fin_normal_end32", name: "みや", text: "じゃあ、これは失敗作ということで、私が全部飲みますね",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_normal_end33" },
    ...
    { id: "fin_normal_end35", name: "みや", text: "ぷはぁ...あれ?無くなっちゃいましたね…?じゃあ新しいやつを作らないと…", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_normal_end36" },
    { id: "fin_normal_end36", name: "あなた", text: "作らないとって、材料もうないよ…!!",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end37" },
    { id: "fin_normal_end37", name: "あなた", text: "さっき作ったので全部だよ…!!どうするの!三重奏できないじゃないか!!", next: "fin_normal_end38" },
    { id: "fin_normal_end38", name: "みや", text: "材料…ないんですか…?そうですね…", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_normal_end39" },
    { id: "fin_normal_end39", name: " ", text: "みやはそういうと机の上にあった棒を手に取った。", next: "fin_normal_end40" },
    { id: "fin_normal_end40", name: "みや", text: "最初に混ぜるのが…確か、赤い液体ですよね?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_normal_end41" },
    { id: "fin_normal_end41", name: "みや", text: "なら、人間の血液で代用できそうじゃないですか…?",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end42" },
    { id: "fin_normal_end42", name: "あなた", text: "…え?", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_normal_end43" },
    { id: "fin_normal_end43", name: "あなた", text: "な、何を言って───", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_normal_end44" },
    { id: "fin_normal_end44", name: " ", text: "みやは清々しいほどの笑顔でこっちに近づいてくる。", se:"walk",portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_normal_end45" },
    { id: "fin_normal_end45", name: "みや", text: "大丈夫ですよ。盃分しかもらわないから、致死量には至らないと思います。",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end46" },
    { id: "fin_normal_end46", name: "あなた", text: "まさか…殺す気か…?", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_normal_end47" },
    { id: "fin_normal_end47", name: "みや", text: "殺したら、犯罪になっちゃうじゃないですか?", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_normal_end48" },
    { id: "fin_normal_end48", name: "みや", text: "それに、こんなに美味しいもの、あなたにもぜひ飲んでもらいたいんです。",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_normal_end49" },
    { id: "fin_normal_end49", name: "みや", text: "だから、協力してくれますよね…", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_normal_end50" },
    { id: "fin_normal_end50", name: "あなた", text: "だ、誰が自分が痛い思いをするのに協力するんだ…!!",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_normal_end51" },
    { id: "fin_normal_end51", name: "みや", text: "…そうですか…半分ごしたら、脱出できるのに───",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_normal_end52" },
    { id: "fin_normal_end52", name: "みや", text: "そこまで拒むのなら…", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_normal_end53" },
    { id: "fin_normal_end53", name: "みや", text: "無理やりにでも奪うしかないですね。",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_normal_end54" },
    ...
    { id: "fin_normal_end59", name: "みや", text: "逃げられませんよ?",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_normal_end60" },
    { id: "fin_normal_end60", name: " ", text: "部屋の角に追いやられた...逃げ道がない。", next: "fin_normal_end61" },
    { id: "fin_normal_end61", name: " ", text: "みやはゆっくり棒を振り下ろす...",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_normal_end62" },
    ...
    { id: "fin_true_end7", name: "みや", text: "あ…先に飲みたかったのに…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "fin_true_end8" },
    ...
    { id: "fin_true_end12", name: "みや", text: "…いえ、やっぱり美味しそうですもんね。", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_true_end13" },
    { id: "fin_true_end13", name: "みや", text: "先に飲みたくなるのも分かります!",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_true_end14" },
    { id: "fin_true_end14", name: "みや", text: "今回は無断で先に飲んだこと許しますが、その代わり残りは全部私の分ですよ…?",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_true_end15" },
    { id: "fin_true_end15", name: "あなた", text: "勿論勿論!はい、どうぞ。", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_true_end16" },
    { id: "fin_true_end16", name: "みや", text: "ありがとうございます!", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_true_end17" },
    { id: "fin_true_end17", name: "みや", text: "それじゃあ…いただきます。",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_true_end18" },
    { id: "fin_true_end18", name: "みや", text: "……!!美味しい!!飲むヨーグルトみたいで飲みやすいです!!",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_true_end20" },
    { id: "fin_true_end20", name: "あなた", text: "凄い勢いで盃の中身が無くなっていくな…", next: "fin_true_end21" },
    { id: "fin_true_end21", name: "みや", text: "…ふぅ、美味しかった。", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_true_end22" },
    { id: "fin_true_end22", name: "みや", text: "この材料…どこかに売ってないんですかね…ここから出ても飲めたらいいな…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_true_end23" },
    { id: "fin_true_end23", name: "あなた", text: "うーん…流石に音が鳴る液体とか見たことないしな…", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_true_end24" },
    ...
    { id: "fin_true_end43", name: "みや", text: "「おーい!!起きてー!!」",se:"magic",set: { bg: "./izumi_bushitsu.jpg" },portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_true_end44" },
    { id: "fin_true_end44", name: "あなた", text: "…!!…みや?", next: "fin_true_end45" },
    { id: "fin_true_end45", name: "みや", text: "あ、やっと起きた!", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_true_end46" },
    { id: "fin_true_end46", name: "みや", text: "あと30分で和泉キャンパス閉まるよ。", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_true_end47" },
    { id: "fin_true_end47", name: "みや", text: "そろそろ帰らないと閉じ込められちゃう",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_true_end48" },
    ...
    { id: "fin_true_end51", name: "みや", text: "記憶…?なんの話?",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_true_end52" },
    { id: "fin_true_end52", name: "みや", text: "もしかして、まだ寝ぼけてる?", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_true_end53" },
    { id: "fin_true_end53", name: "あなた", text: "寝ぼけて…?",next: "fin_true_end54" },
    { id: "fin_true_end54", name: "あなた", text: "自分は…寝てたのか…?",next: "fin_true_end55" },
    { id: "fin_true_end55", name: "みや", text: "寝てたのかって…私が部室に来たら、君がここで寝てたんじゃん。",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "fin_true_end56" },
    { id: "fin_true_end56", name: "みや", text: "一向に声かけても、三味線鳴らしても起きないからどうしようと思ったよ…",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_true_end57" },
    { id: "fin_true_end57", name: "みや", text: "ま、起きてくれてよかったけど。", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_true_end58" },
    { id: "fin_true_end58", name: "みや", text: "あと一分起きなかったら、一発殴ってたかな?",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_true_end59" },
    { id: "fin_true_end59", name: "あなた", text: "な、殴る…!!",portrait:{ who:"miya", face:"normal", size:"500px" }, next: "fin_true_end60" },
    { id: "fin_true_end60", name: "みや", text: "あと、5分で帰宅準備できなかったら、ビンタかグーパンチかキックか…",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_true_end61" },
    { id: "fin_true_end61", name: "あなた", text: "す、すぐ準備します…!!!",portrait:{ who:"miya", face:"kind", size:"500px" }, next: "fin_true_end62" },
    { id: "fin_true_end62", name: "みや", text: "…ハハッ、冗談だよ、冗談。", portrait:{ who:"miya", face:"smile", size:"500px" },next: "fin_true_end63" },
    { id: "fin_true_end63", name: "あなた", text: "(あれ…?この会話、)", next: "fin_true_end64" },
    { id: "fin_true_end64", name: "みや", text: "まだ寝ぼけてそうだったから、起こしてやろうと思って", portrait:{ who:"miya", face:"kind", size:"500px" },next: "fin_true_end65" },
    { id: "fin_true_end65", name: "あなた", text: "(…凄く既視感を感じる)", next: "fin_true_end66" },
    { id: "fin_true_end66", name: "みや", text: "時間はまだ余裕があるし、ゆっくり支度して大丈夫だよ。", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_true_end67" },
    { id: "fin_true_end67", name: "あなた", text: "…うん、ありがとう。", portrait:{ who:"miya", face:"normal", size:"500px" },next: "fin_true_end68" },
    { id: "fin_true_end68", name: "みや", text: "…‼ふふ、礼を言われるほどじゃないですよ〜",portrait:{ who:"miya", face:"smile", size:"500px" }, next: "fin_true_end69" },
    ...
    { id: "fin_bad_end2", name: "みや", text: "また、白い部屋が揺れて…!!",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_bad_end3" },
    { id: "fin_bad_end3", name: " ", text: "ピーンポーンパーンポーン",se:"bell", next: "fin_bad_end4" },
    { id: "fin_bad_end4", name: "あなた", text: "ま、またチャイム?", next: "fin_bad_end5" },
    { id: "fin_bad_end5", name: "みや", text: "今度は…なんでしょう?", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "fin_bad_end6" },
    ...
    { id: "fin_bad_end31", name: " ", text: "後ろを振り返れば、血濡れたナイフを持ったみやが、生気の無い目でこっちを見ている。",portrait:{ who:"miya_bad", face:"normal", size:"500px" }, next: "fin_bad_end32" },
    { id: "fin_bad_end32", name: "あなた", text: "みや…どうして…", portrait:{ who:"miya_bad", face:"normal", size:"500px" },next: "fin_bad_end33" },
    { id: "fin_bad_end33", name: "みや(?)", text: "……",portrait:{ who:"miya_bad", face:"normal", size:"500px" }, next: "fin_bad_end34" },
    { id: "fin_bad_end34", name: "あなた", text: "(だめだ…足に力が…入らな…)",portrait:{ who:"miya_bad", face:"normal", size:"500px" }, next: "fin_bad_end35" },
    { id: "fin_bad_end35", name: " ", text: "バタン(視界暗転)",set: { bg: "#000" }, next: "fin_bad_end36" },
    { id: "fin_bad_end36", name: " ", text: "……", portrait:{ who:"miya_bad", face:"normal", size:"500px" },next: "fin_bad_end37" },
    { id: "fin_bad_end37", name: " ", text: "……実験は失敗。",portrait:{ who:"miya_bad", face:"normal", size:"500px" }, next: "fin_bad_end38" },
    { id: "fin_bad_end38", name: "みや(?)", text: "…ふふ…",portrait:{ who:"miya_bad", face:"normal", size:"500px" }, next: "fin_bad_end39" },
    { id: "fin_bad_end39", name: "みや(?)", text: "…あはははははは!!",portrait:{ who:"miya_bad", face:"smile", size:"500px" }, next: "fin_bad_end40" },
    { id: "fin_bad_end40", name: "みや(?)", text: "……", portrait:{ who:"miya_bad", face:"smile", size:"500px" },next: "fin_bad_end41" },
    { id: "fin_bad_end41", name: "みや(?)", text: "…ぜんぶ、あなたのせいだから。",portrait:{ who:"miya_bad", face:"angry", size:"500px" }, next: "fin_bad_end42" },
    { id: "fin_bad_end42", name: "みや(?)", text: "……はぁ、疲れた。", portrait:{ who:"miya_bad", face:"normal", size:"500px" },next: "fin_bad_end43" },
    ...
    // === HIDDEN END(隠されたエンド) ===
    { id: "fin_hidden_end", name: "みや", text: "……なんでそんなに、躊躇うんですか!!",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "fin_hidden_end2" },
    { id: "fin_hidden_end2", name: "あなた", text: "もしかして…先に飲もうとしてます…?", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "fin_hidden_end3" },
    { id: "fin_hidden_end3", name: "あなた", text: "ちょっと待って!!間違ったら大変じゃないか!",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_hidden_end4" },
    { id: "fin_hidden_end4", name: "みや", text: "本当に順番に関して何かなかったかって思い返してるから…",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_hidden_end5" },
    { id: "fin_hidden_end5", name: "あなた", text: "だとしても長すぎます…!!", portrait:{ who:"miya", face:"fear", size:"500px" },next: "fin_hidden_end6" },
    { id: "fin_hidden_end6", name: "みや", text: "さっきから我慢して我慢して…もう耐えられません…!!",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_hidden_end7" },
    ...
    { id: "fin_hidden_end10", name: "みや", text: "……割れた?", portrait:{ who:"miya", face:"confuse", size:"500px" },next: "fin_hidden_end11" },
    ...
    { id: "fin_hidden_end13", name: " ", text: "床には盃の破片と、白い液体が散らばっている。", next: "fin_hidden_end14" },
    { id: "fin_hidden_end14", name: "みや", text: "ど、どうしましょう…",portrait:{ who:"miya", face:"fear", size:"500px" }, next: "fin_hidden_end15" },
    ...
    { id: "fin_hidden_end18", name: "みや", text: "わ、私、液体を掬いあげるスプーンみたいなの探してきます", portrait:{ who:"miya", face:"fear", size:"500px" },next: "fin_hidden_end19" },
    ...
    { id: "fin_hidden_end21", name: "あなた", text: "…‼", portrait:{ who:"miya", face:"fear", size:"500px" },next: "fin_hidden_end22" },
    { id: "fin_hidden_end22", name: "みや", text: "頭の中に声が響いてる感じがします…!!",portrait:{ who:"miya", face:"confuse", size:"500px" }, next: "fin_hidden_end23" },
    ...
    { id: "fin_hidden_end26", name: "あなた", text: "…動いてる?", portrait:{ who:"miya", face:"ormal", size:"500px" },next: "fin_hidden_end27" },
    { id: "fin_hidden_end27", name: "???", text: "「あ…やっと気づいた?」",overlay: { sprite: "./みや.mile.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end28" },
    { id: "fin_hidden_end28", name: "???", text: "「君たちのこと、ここからずっと見させてもらってたよ。」",overlay: { sprite: "./みや.ormal.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"},  next: "fin_hidden_end29" },
    { id: "fin_hidden_end29", name: "???", text: "「私は、君たちには期待していたんだけどな…きっといい演奏してくるって。」", overlay: { sprite: "./みや.shock.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end30" },
    { id: "fin_hidden_end30", name: "???", text: "「それなのに……君たちは君たち自身で演奏を台無しにした。」",overlay: { sprite: "./みや.angry.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end31" },
    { id: "fin_hidden_end31", name: "???", text: "「今回は期待はずれだったかな?」", overlay: { sprite: "./みや.ind.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"} ,next: "fin_hidden_end32" },
    { id: "fin_hidden_end32", name: "???", text: "「君たちは、私の時間を期待を、想いを無駄にした。」",overlay: { sprite: "./みや.angry.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"}, next: "fin_hidden_end33" },
    { id: "fin_hidden_end33", name: "???", text: "「どうやら、君たちには…」",overlay: { sprite: "./みや.ind.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"},  next: "fin_hidden_end34" },
    { id: "fin_hidden_end34", name: "???", text: "「…お仕置きが必要そうだね」",overlay: { sprite: "./みや.magic.png", withText: true ,size: "60vh",left: "75%", bottom: "0",transform: "translateX(-50%)"},  next: "fin_hidden_end35" },
